        ...
        <>
            ...
            <div className="inicio-about flex flex-col items-center w-full pb-80 gap-4">
                ...
                <p className="text-xl w-3/4">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Totam eveniet id voluptatibus, adipisci perferendis inventore corporis ipsum atque delectus in. Corporis quibusdam vero ducimus eos voluptatum consectetur mollitia tempore. Numquam!</p>
            </div>
        </>
    )
}
